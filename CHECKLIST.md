...
- [ ] Data Sources / Webhooks:
  ...
  - [ ] Mapping upload/download.
- [ ] Automations / Triggers:
  - [x] List automations and executions.
  - [x] Trigger execution.
  - [ ] Manage schedules (if exposed).
- [ ] Access / Users / Teams:
  - [ ] List users/teams/roles.
  - [ ] Assign roles or permissions if API supports it.
...
- [ ] Update top-level README with:
  ...
  - [ ] Region selection snippet.
  - [ ] Auth snippet (client credentials + personal token).
  - [ ] Link matrix to docs/examples per API group.
